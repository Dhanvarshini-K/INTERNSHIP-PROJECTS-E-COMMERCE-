  ...
  return (
    <React.Fragment>
            ...
            <div className="col-lg-2 col-md-3 py-2 d-flex flex-column gap-4">
              ...
              <div className="d-none d-md-block d-md-flex flex-md-column gap-3">
                ...
                <div className="categories_list navbar d-flex flex-column align-items-start fw-medium fs-5 gap-2 flex-nowrap pb-5">
                  <Link className="nav-link" to="/allrooms">All Rooms</Link>
                  <Link className="nav-link" to="/livingroom">Living Room</Link>
                  <Link className="nav-link" to="/bedroom">Bedroom</Link>
                  <Link className="nav-link" to="/kitchen">Kitchen</Link>
                  <Link className="nav-link" to="/bathroom">Bathroom</Link>
          ...
          <div className="col-lg-10 col-md-9 d-flex flex-column gap-2 py-2 ">
            <div className="shoplist_container px-3 gap-2 flex-wrap">
              <div className="sortby_container d-flex justify-content-between">
                {!gridHeading &&
                  <span className="livingroom_container h2 fw-bold">{pathname === "/allrooms" || pathname === '/shop' ? "All Rooms" : category}</span>
                }
                {gridHeading &&
      ...
      <div className="p-4 d-flex justify-content-center">
        <button onClick={() => setShowMore(!showMore)} className="btn shadow-none bg-white btn-rounded border-dark">{showMore ? "Show Less" : "Show More"}</button>
      </div>
    </React.Fragment>
  );
};
