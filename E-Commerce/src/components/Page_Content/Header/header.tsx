            ...
            <nav className="navbar navbar-expand-md">
                <div className="container">
                    ...
                    <div className="d-flex gap-3 order-md-3">
                        ...
                        {openSearch &&
                            <input type="search" className="rounded border-1 ps-2 border-secondary" placeholder="Search"
                            />
                        ...
                        <button className="border-0 bg-transparent">
                            <Link to="/cart" className="d-flex text-decoration-none">
                                ...
                                <div className="cart_count bg-dark rounded-circle text-white fw-medium  text-center d-flex justify-content-center align-items-center">0</div>
                            </Link>
                        </button>
                                ...
                                <div className="offcanvas-body d-flex justify-content-sm-start justify-content-md-center">
                                    <ul className="navbar-nav justify-content-start flex-grow-3 fs-6 fw-medium">
                                        <li className="nav-item">
                                            <Link to="/home"  aria-current="page" className={`nav-link ${location.pathname === '/home' ? 'active' : ''}`}>
                                                Home
                                            </Link>
                                        </li>
                                        <div className="vertical_line d-md-none d-sm-block border-1 border-bottom"></div>
                                        <li className="nav-item">
                                            <Link to="/shop"  aria-current="page" className={`nav-link ${location.pathname === '/shop' ? 'active' : ''}`}>
                                                Shop
                                            </Link>
                                        </li>
                                        <div className="vertical_line d-md-none d-sm-block border-1 border-bottom"></div>
                                        <li className="nav-item">
                                            <Link to="/product" aria-current="page" className={`nav-link ${location.pathname === '/product' ? 'active' : ''}`}>
                                                Product
                                            </Link>
                                        </li>
                                        <div className="vertical_line d-md-none d-sm-block border-1 border-bottom"></div>
                                        <li className="nav-item">
                                            <Link to="/blog" aria-current="page" className={`nav-link ${location.pathname === '/blog' ? 'active' : ''}`}>
                                                Blog
                                            </Link>
                                        </li>
                                        <div className="vertical_line d-md-none d-sm-block border-1 border-bottom"></div>
                                        <li className="nav-item">
                                            <Link to="/contact" aria-current="page" className={`nav-link ${location.pathname === '/contact' ? 'active' : ''}`}>
                                                Contact us
                                            </Link>
                                        </li>
                                        <div className="vertical_line d-md-none d-sm-block border-1 border-bottom"></div>
