        ...
        <section className='d-flex flex-column gap-3'>
            ...
            <div className='cart_header d-flex justify-content-md-center gap-5'>
                <div className='d-flex gap-2 align-items-center ps-3'>
                    ...
                    <Link to="/cart" className='text-decoration-none text-dark h5'>Shopping cart</Link>
                </div>
                <div className='d-flex gap-2 align-items-center'>
                    <img src={cart_two_light} alt="cart_two_light" className='cart_image' />
                    <Link to="/checkout" className='text-decoration-none text-dark h5'>Check Out</Link>

                </div>
                <div className='d-flex gap-2 align-items-center'>
                    <img src={cart_three_light} alt="cart_three_light"  className='cart_image'/>
                    <Link to="#" className='text-decoration-none text-dark h5'>Order complete</Link>
                </div>
            </div>
